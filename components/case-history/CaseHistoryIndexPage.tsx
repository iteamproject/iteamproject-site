...
const copy = {
  it: {
    ...
    portfolioText:
      "Casi selezionati per mostrare approcci diversi: infrastruttura, governance, service management e controllo della delivery.",
    summary: [
      "Case history bilingue",
      "Modello dati centralizzato",
      "Contenuti estendibili",
    ],
    cta: "Leggi il caso",
  },
  en: {
    ...
    portfolioLabel: "Portfolio",
    portfolioText:
      "Selected cases showing different approaches: infrastructure, governance, service management and delivery control.",
    summary: [
